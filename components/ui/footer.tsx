				...
				<div className="flex flex-col space-y-8">
					<div className="flex flex-col lg:flex-row lg:items-center justify-between py-8 border-t border-gray-800/30 space-y-8 lg:space-y-0">
						<div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
								<div className="text-base text-green-200/65">
									<span className="font-medium text-white text-lg mb-1 block">
										Business
									</span>
									<a
								...
								<div className="text-base text-green-200/65">
									<span className="font-medium text-gray-200 text-lg mb-1 block">
										Our Office
									</span>
									<span className="inline-block">Bangladesh</span>
								</div>
							</div>
						</div>
						<div className="flex flex-col items-start lg:items-end gap-4">
							...
							<ul className="flex items-center gap-6">
								...
								<li>
									<a
										className="flex items-center justify-center text-green-500 transition hover:text-green-400"
										href="https://www.linkedin.com/company/jaldipay/"
										aria-label="LinkedIn">
										<svg
											className="h-7 w-7 fill-current"
											viewBox="0 0 32 32"
					...
					<div className="pb-8 text-center">
						<p className="text-base text-green-200/65">
							© {new Date().getFullYear()} jaldipay.com. All rights reserved.
						</p>
					</div>
				</div>
				{/* </div> */}
